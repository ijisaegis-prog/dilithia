...
every instantiated paired manifest fail-closed for required fields, digests,
paths, co-equal binding classes, identities, and status/result consistency. It
also classifies every metric-bearing candidate paragraph, requiring paired
measurements and same-block provenance for candidate-specific values, preserves
incomplete historical observations as reported or pending, and asserts the
exact intended status distinction across the five governing records.
...
Aggregate SHA-256: `a1ab0e92b3cd88b2567df73a29d38fceed9700af9ad540e50d589611f8329743`
...
| `PACKAGE_WIDE_SAFE_CHECK.ps1` | `993d17c5e9733b0ba9701772e1d1da8e3a3eab0b78271672020b7b4a59a12887` |
