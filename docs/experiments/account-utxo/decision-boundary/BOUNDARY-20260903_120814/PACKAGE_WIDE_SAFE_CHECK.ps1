...
$selectionNegated=@('AUTOPILOT_EXECUTION_BOUNDARY.md:14','AUTOPILOT_EXECUTION_BOUNDARY.md:35','AUTOPILOT_EXECUTION_FINAL_DUAL_REVIEW.md:7','AUTOPILOT_EXECUTION_FINAL_DUAL_REVIEW.md:8','AUTOPILOT_EXECUTION_FINAL_DUAL_REVIEW.md:10','AUTOPILOT_EXECUTION_FINAL_DUAL_REVIEW.md:11','DECISION_QUEUE_UNCHANGED.md:3','DECISION_QUEUE_UNCHANGED.md:4','DECISION_QUEUE_UNCHANGED.md:8','DECISION_QUEUE_UNCHANGED.md:22','EXECUTION_MANIFEST.md:79','FIXED_POINT_REPORT.md:42','FIXED_POINT_REPORT.md:53','FIXED_POINT_REPORT.md:54','GATE1_RERUN_PRE_RESULT_MANIFEST_TEMPLATE.md:99','GATE1_RERUN_PRE_RESULT_MANIFEST_TEMPLATE.md:100','NEXT_SAFE_AUTOMATION_QUEUE.md:27','PAIRED_CONTENT_ADDRESSABLE_MANIFEST_TEMPLATE.md:5','README.md:4','README.md:39','README.md:40','README.md:42','README.md:43','RESUME_CODE_HEALTH_RECEIPT.md:257','RESUME_CODE_HEALTH_RECEIPT.md:258','RESUME_CODE_HEALTH_RECEIPT.md:260','RESUME_CODE_HEALTH_RECEIPT.md:261')
